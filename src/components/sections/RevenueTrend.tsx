...
import { revenueTrendKPIs, revenueTrendData, revenueEvents } from "../../data/mock-data"
...
export function RevenueTrend() {
  return (
    <section>
      ...
      <Card>
        {/* Filter controls — dropdowns, not tabs */}
        ...
        <div className="mb-2">
          ...
          <ResponsiveContainer width="100%" height={320}>
            <BarChart data={revenueTrendData} barGap={0} barCategoryGap="20%">
